...
public class EnvironmentGenerator {
	...
	public EnvironmentGenerator(SootMethod method, PointsToInitializer pointsTo) {
		...
		// Use the unique label as a variable for received_amount.
		for (StoreInitializer initializer : this.pointsTo.getInitializers(method)) {
			this.ints.add(initializer.getUniqueLabel());
		}
